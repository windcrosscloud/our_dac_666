...
################################################################
# This is a generated script based on design: dac_sys
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set IO_data [ create_bd_port -dir O -from 13 -to 0 IO_data ]
  set dac_sys_clk [ create_bd_port -dir O dac_sys_clk ]
  ...
  set_property -dict [ list \
   CONFIG.DEFAULT_PHASE_STEP {"00000000000000000110010110101110"} \
 ] $our_dac_0
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins our_dac_0/S0_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net our_dac_0_IO_data [get_bd_ports IO_data] [get_bd_pins our_dac_0/IO_data]
  connect_bd_net -net our_dac_0_dac_sys_clk [get_bd_ports dac_sys_clk] [get_bd_pins our_dac_0/dac_sys_clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins our_dac_0/s0_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins our_dac_0/s0_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net sys_clk_0_1 [get_bd_ports sys_clk] [get_bd_pins our_dac_0/sys_clk]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs our_dac_0/S0_AXI/S0_AXI_reg] SEG_our_dac_0_S0_AXI_reg

...
HD_PWD='D:/custom_ip/our_dac_666/our_dac_666.runs/dac_sys_our_dac_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dac_sys_our_dac_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dac_sys_our_dac_0_0.tcl

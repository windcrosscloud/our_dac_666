...
HD_PWD='D:/custom_ip/our_dac_666/our_dac_666.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dac_sys_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dac_sys_wrapper.tcl -notrace

...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "DEFAULT_PHASE_STEP" -parent ${Page_0} -widget comboBox
...
proc update_PARAM_VALUE.DEFAULT_PHASE_STEP { PARAM_VALUE.DEFAULT_PHASE_STEP } {
	# Procedure called to update DEFAULT_PHASE_STEP when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.DEFAULT_PHASE_STEP { PARAM_VALUE.DEFAULT_PHASE_STEP } {
	# Procedure called to validate DEFAULT_PHASE_STEP
	return true
}
...
proc update_MODELPARAM_VALUE.DEFAULT_PHASE_STEP { MODELPARAM_VALUE.DEFAULT_PHASE_STEP PARAM_VALUE.DEFAULT_PHASE_STEP } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.DEFAULT_PHASE_STEP}] ${MODELPARAM_VALUE.DEFAULT_PHASE_STEP}
}

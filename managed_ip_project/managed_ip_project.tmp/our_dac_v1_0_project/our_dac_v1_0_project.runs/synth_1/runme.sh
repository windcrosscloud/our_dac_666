...
HD_PWD='D:/custom_ip/managed_ip_project/managed_ip_project.tmp/our_dac_v1_0_project/our_dac_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log our_dac_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source our_dac_v1_0.tcl
